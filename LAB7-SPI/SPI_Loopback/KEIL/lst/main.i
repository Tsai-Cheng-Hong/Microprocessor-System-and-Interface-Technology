...
void SPI_Init(void)
{
    ...
    SPI_Open(((SPI_T *) ((( uint32_t)0x40100000) + 0x30000)), (0x0), ((1ul << 11) | (1ul << 2)), 8, 1000000);
    ...
    ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->CNTRL |= (0x0);
...
{
    ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->TX[0] = 0x00 | reg;
...
uint8_t SPI_Read(uint8_t reg)
{
    ...
    ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->TX[0] = 0x80 | reg;
...
int main(void)
{
    ...
    printf("\n");
		...
		while(1){
			...
			TEMP[0]=SPI_Read(0x32);
			TEMP[1]=SPI_Read(0x33);
			TEMP[2]=SPI_Read(0x34);
			TEMP[3]=SPI_Read(0x35);
			TEMP[4]=SPI_Read(0x36);
			TEMP[5]=SPI_Read(0x37);
