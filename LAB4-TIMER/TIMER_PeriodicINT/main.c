...
int main(void)
{
    ...
    printf("  Timer0: Clock source 12 MHz;       Periodic mode; Enable interrupt; 2 interrupt tick/sec.\n");
    ...
    printf("  Timer3: Clock source 12 MHz;       Periodic mode; Enable interrupt; 3 interrupt ticks/sec.\n");
    ...
    printf("\n    Start TIMER    \n");
		while(1){
			printf("\r TMR0:%3d TMR3:%3d",g_au32TMRINTCount[0],g_au32TMRINTCount[3]);
			CLK_SysTickDelay(45000);
			num=ScanKey();	
			if(num==1){
				if(flag1){
					flag1=0;
